...
[algorithm downgrade attacks](https://www.rfc-editor.org/rfc/rfc9421.html#section-7.3.6). Bind each
key to its algorithm in trusted configuration and keep the verification allowlist narrow.
