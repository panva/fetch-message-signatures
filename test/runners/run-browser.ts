// Browser entry point for the shared suite. Bundled to test/browser-suite.js by test/bundle.js and
// loaded by test/browser.html, which test/browser.mjs drives through Playwright.
//
