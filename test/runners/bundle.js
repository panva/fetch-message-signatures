...
//
//   node test/bundle.js browser    -> test/browser-suite.js
//   node test/bundle.js workerd    -> test/run-workerd.bundle.js
//
...
const TARGETS = {
  browser: { entry: 'run-browser.ts', outfile: 'browser-suite.js' },
