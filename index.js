...
function deriveFieldComponentValue(
  ...
  if (key !== undefined) {
    ...
    if (field.members === undefined) {
      const dictionary = parseStructuredField(field.combined, 'dictionary')                
...
function parseSignatureInputInternal(value        )                         {
  const dictionary = parseStructuredField(value, 'dictionary', true)                
...
function parseSignatureFieldDictionaries(headers         )   
  ...
  const inputs = parseStructuredField(signatureInput, 'dictionary', true)                
  const values = parseStructuredField(signature, 'dictionary', true)                
